                ...
                <form>
                    <div className="row">
                        <div className="col-lg-2">
                            <input className="form-control" ref="name" placeholder="姓名"/>
                        </div>
                        <div className="col-lg-2">
                            <Select ref="gender" placeholder="性别"
                                    options={[{label: "请选择", value: "0"}, {label: "男", value: "1"}, {
                                        label: "女",
                                        value: "2"
                                    }]}/>
                        </div>
                        ...
                        <div className={this.state.show.idNo ? 'col-lg-2 has-error' : 'col-lg-2'}>
                            <div ref="idNoParent">
                                <input className="form-control" ref="idNo" onChange={this.canncleTips.bind(this)}
                                       placeholder="证件号"/>
                            </div>
                        </div>

                        <div className="col-lg-2">
                            <div className={this.state.show.tel ? 'input-group has-error' : 'input-group'}>
                                <div ref="telParent"><input className="form-control" ref="tel" placeholder="手机"
                                                            onChange={this.canncleTips.bind(this)}/></div>
                                <span className="input-group-btn">
                                <button className="btn btn-info" type="button" onClick={this.queryPeople.bind(this)}
                                        style={{"margin-left": "5px", "background-color": "#20A0FF"}}>查询</button>
                            </span>
                            </div>
                        </div>
                    </div>
