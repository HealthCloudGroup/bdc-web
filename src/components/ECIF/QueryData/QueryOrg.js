                ...
                <form>
                    <div className="row">
                        <div className="col-lg-2">
                            <div className={this.state.show.orgno ? 'input-group has-error' : 'input-group'}>
                                <div ref="orgParent"><input className="form-control" ref="orgno"  onChange={this.canncleTips.bind(this)} placeholder="组织机构编号"/></div>
                                <span className="input-group-btn">
                                <button className="btn btn-info" type="button" onClick={this.queryOrg.bind(this)}
                                        style={{"margin-left": "30px", "background-color": "#20A0FF"}}>查询</button>
                            </span>
                            </div>
                        </div>
                    </div>
